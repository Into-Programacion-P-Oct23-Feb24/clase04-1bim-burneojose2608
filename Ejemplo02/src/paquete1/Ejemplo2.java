...
public class Ejemplo2 {
    ...
    public static void main(String[] args) {
        ...
        entrada.nextLine(); // limpieza de buffer se hace cuando tenemos cadena y decimal seguido y tenemos que volver a poer una cadena necesitammos hacer un buffer
